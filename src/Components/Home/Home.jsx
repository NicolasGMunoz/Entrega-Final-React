    ...
    return (<>
        ...
        <Card sx={{ width: "330px", height: "230px", margin: "40px", background:"transparent", border:"solid 1px gray" }} className="cardCont">
            <CardContent >
                ...
                <Typography color="white" padding={"15px"}>Abonando con Debito el precio es el mismo</Typography>
            </CardContent>
        </Card>
        ...
        <Card sx={{ width: "330px", height: "230px", margin: "40px", background:"transparent", border:"solid 1px gray" }} className="cardCont">
            <CardContent >
                ...
                <Typography color="white" padding={"15px"}>Abonando con Credito tiene un 5% de recargo y las cuotas estan sujetas a cada Banco</Typography>
            </CardContent>
        </Card>
        </div>
